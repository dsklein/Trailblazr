...
for i in range(0,4):
	plot.scatter(histlist_totalslope[i],histlist_horizlength[i],c=colors[i],alpha=0.2,label=labels[i])
plot.xlabel('Total Slope')
plot.ylabel('Horizontal length')
plot.legend()
# plot.show()
plot.savefig('../pictures/horizlength_vs_totalslope.png')
print('Saved ../pictures/horizlength_vs_totalslope.png')
plot.clf()
time.sleep(0.2)
...
plot.legend()
# plot.show()
plot.savefig('../pictures/horizlength_vs_sinuosity.png')
print('Saved ../pictures/horizlength_vs_sinuosity.png')
plot.clf()
time.sleep(0.2)
